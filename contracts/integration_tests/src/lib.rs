...
// Integration tests for CredentialProtocol contract interactions (#364)
...
mod integration {
    ...
    // ── E2E: verify_credential_holder cross-contract call ──────────────────────────────

    #[test]
    fn test_e2e_verify_credential_holder_with_sbt_and_zk() {
        let env = Env::default();
        let c = setup(&env);
    ...
    #[test]
    fn test_e2e_verify_credential_holder_fails_without_sbt() {
        let env = Env::default();
        let c = setup(&env);
    ...
    // ── E2E: verify_credential_holder fails with wrong credential id ───────────────────

    #[test]
    fn test_e2e_verify_credential_holder_wrong_credential() {
        let env = Env::default();
        let c = setup(&env);
