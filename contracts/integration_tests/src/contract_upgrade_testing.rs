...
mod contract_upgrade_testing {
    ...
    struct UpgradeTestSetup<'a> {
        qp: CredentialProtocolContractClient<'a>,
    ...
    fn test_upgrade_state_preservation() {
        ...
        let qp_new_id = env.register_contract(None, CredentialProtocolContract);
        let qp_new = CredentialProtocolContractClient::new(&env, &qp_new_id);
    ...
    fn test_upgrade_testnet_scenario() {
        ...
        let qp_upgraded_id = env.register_contract(None, CredentialProtocolContract);
        let qp_upgraded = CredentialProtocolContractClient::new(&env, &qp_upgraded_id);
    ...
    fn test_upgrade_rollback() {
        ...
        let qp_failed_id = env.register_contract(None, CredentialProtocolContract);
        let qp_failed = CredentialProtocolContractClient::new(&env, &qp_failed_id);
    ...
    fn test_upgrade_multi_step_scenario() {
        ...
        let qp_v2_id = env.register_contract(None, CredentialProtocolContract);
        let qp_v2 = CredentialProtocolContractClient::new(&env, &qp_v2_id);
        ...
        let qp_v3_id = env.register_contract(None, CredentialProtocolContract);
        let qp_v3 = CredentialProtocolContractClient::new(&env, &qp_v3_id);
