...
fn test_standard_batch(env: &Env, client: &CredentialProtocolContractClient, input: &BatchOperationsFuzzInput) {
...
fn test_large_batch(env: &Env, client: &CredentialProtocolContractClient, input: &BatchOperationsFuzzInput) {
    let issuer = Address::generate(&env);
...
fn test_sequential_issuance(env: &Env, client: &CredentialProtocolContractClient, input: &BatchOperationsFuzzInput) {
    let issuer = Address::generate(&env);
...
fn test_mixed_batch_sizes(env: &Env, client: &CredentialProtocolContractClient, input: &BatchOperationsFuzzInput) {
    let issuer = Address::generate(&env);
...
fn test_batch_with_verification(env: &Env, client: &CredentialProtocolContractClient, input: &BatchOperationsFuzzInput) {
    let issuer = Address::generate(&env);
